...
public class ChnMoneyFunction extends MathFunction {
	...
	private static final String[] CN_UPPER_UNIT = { "分", "角", "元", "拾", "佰", "仟", "万", "拾", "佰", "仟", "亿", "拾", "佰",
			"仟", "兆", "拾", "佰", "仟" };
	...
	private static String numberToRMB(BigDecimal numberData) {
		...
		long number = numberData.movePointRight(NUMBER_PRECISION).setScale(0, BigDecimal.ROUND_HALF_UP).abs()
				.longValue();
