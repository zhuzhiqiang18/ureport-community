...
public class WordComboChart implements WordChart {
	...
	private void handleLeft(XWPFChart chart, ChartOption options, XSSFSheet sheet, String sheetName, XDDFCategoryDataSource xAxisSource,XDDFCategoryAxis xAxis, int rowIndex) {
	...
	private void handleRight(XWPFChart chart, ChartOption options, XSSFSheet sheet, String sheetName, XDDFCategoryDataSource xAxisSource,XDDFCategoryAxis xAxis, int rowIndex) {
