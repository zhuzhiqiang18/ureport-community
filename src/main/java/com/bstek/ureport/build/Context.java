...
public class Context {
	...
	public Context(ReportBuilder reportBuilder, Report report, Map<String, Dataset> datasetMap,
			Map<String, Object> parameters, HideRowColumnBuilder hideRowColumnBuilder) {
	...
	public Map<String, String> getMapping(DatasetExpression expr) {
		if (expr.getMappingType().equals(MappingType.simple)) {
			...
			if (StringUtils.isNotBlank(expr.getMappingDataset()) && StringUtils.isNotBlank(expr.getMappingKeyProperty())
					&& StringUtils.isNotBlank(expr.getMappingValueProperty())) {
