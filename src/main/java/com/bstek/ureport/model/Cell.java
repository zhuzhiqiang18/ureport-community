...
public class Cell implements ReportCell {
	 ...
	 * 当前单元格所在行所有子格名称
	 */
	private Map<String, Boolean> rowAllChildrenCellsMap = null;
	
	/**
	 * 当前单元格下一级子格
	 */
	private Map<String, List<Cell>> rowChildrenCellsMap = null;
	
	/**
	 * 当前单元格所在列所有子格名称
	 */
	private Map<String, Boolean> columnAllChildrenCellsMap = null;
	
	/**
	 * 当前单元格所在列所有子格
	 */
	private Map<String, List<Cell>> columnChildrenCellsMap = null;
	...
	public void addRowChild(Cell child) {
		...
		if(rowChildrenCellsMap == null) {
			rowChildrenCellsMap = new HashMap<String, List<Cell>>();
		}
...
//		}
	...
	public void addColumnChild(Cell child) {
		String name = child.getName();
		if(columnChildrenCellsMap == null) {
			columnChildrenCellsMap = new HashMap<String, List<Cell>>();
		}
...
//		}
	...
	public void addRowChildName(String cellName) {
		if(rowAllChildrenCellsMap == null) {
			rowAllChildrenCellsMap = new HashMap<String, Boolean>();
		}
		this.rowAllChildrenCellsMap.put(cellName, true);
	}
	
	public boolean hasRowChildByCellName(String cellName) {
		if(rowAllChildrenCellsMap != null && rowAllChildrenCellsMap.get(cellName) != null) {
			return true;
		}
		return false;
	}
	
	public void addColumnChildName(String cellName) {
		if(columnAllChildrenCellsMap == null) {
			columnAllChildrenCellsMap = new HashMap<String, Boolean>();
		}
		this.columnAllChildrenCellsMap.put(cellName, true);
	}
	
	public boolean hasColumnChildByCellName(String cellName) {
		if(columnAllChildrenCellsMap != null && columnAllChildrenCellsMap.get(cellName) != null) {
			return true;
		}
		return false;
	}
