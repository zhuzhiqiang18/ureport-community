<template>
  <div>
    <el-collapse v-model="activeNames">
      ...
      <el-collapse-item :disabled="!form.global.areaStyle.show" name="areaStyle">
        <template slot="title">
          <el-switch v-model="form.global.areaStyle.show" class="el-switch-mimi" style="width:20px;margin-right:5px" @change="handleChange($event,'areaStyle')" />
          背景
        </template>
        <el-form class="div-block-clearance" label-position="left" label-width="90px" :model="form.global" size="mini" style="margin-top: 10px;">
          <el-form-item label="透明度">
            <el-input-number v-model="form.global.areaStyle.opacity" style="width: 100%;" placeholder="" :min="0" :max="1" :step="0.1" controls-position="right" />
          </el-form-item>
        </el-form>
      </el-collapse-item>
      ...
      <el-collapse-item title="展示样式" name="global">
        <el-form class="div-block-clearance" label-position="left" label-width="90px" :model="form.global" size="mini" style="margin-top: 10px;">
          ...
          <el-form-item label="边界值">
            <el-input-number v-model="form.global.max" style="width: 100%;" placeholder="" :min="0" controls-position="right" />
          </el-form-item>
